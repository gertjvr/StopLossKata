...
{
    [TestFixture]
    public class When_checking_for_price_increase_and_the_stock_price_has_increased : AutoNSubsituteSpecificationFor<StopLossSaga>
    {
        ...
        [Then]
        public void Should_increase_sell_point_by_the_default_margin()
        {
